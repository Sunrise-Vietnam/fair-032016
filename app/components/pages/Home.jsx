		...
		return <div>
					...
					<form className="form-horizontal">
						...
						<div className="form-group">
							...
							<div
								...
								<select
									className={`form-control ${styles.customInput}`} {...this._handleChange('thanhphodangsong')}>
							...
							<div
								...
								<select className={`form-control selectpicker`}
								        ...
								        data-selected-text-format="count>1" {...this._handleMultiChange('duhoctai')}>
							...
							<div
								className={`col-xs-12 col-sm-6 col-md-4 ${styles.marginBottomXS} ${styles.marginBottomSM}`}>
								<select
									className={`form-control ${styles.customInput}`}  {...this._handleChange('thoigianduhoc')}>
							...
							<div className={`col-xs-12 col-sm-6 col-md-4 ${styles.marginBottomXS}`}>
								<select
									className={`form-control ${styles.customInput}`}  {...this._handleChange('nhucauhoc')}>
							...
							<div className="col-xs-12">
								<div className={styles.smallSpacing}></div>
								<button disabled={!this._isFormValid} className={`${styles.btnBlock}`} id={`${styles.btnRegister}`} type="button"
			...
			<div className={`${styles.opportunities}`}>
				<div className="container">
					...
					<div className="col-xs-12 col-sm-6">
						<div className="row">
							<div
								className="col-xs-4 col-xs-offset-4 col-sm-3 col-sm-offset-0 col-md-2 col-md-offset-2 text-right">
					...
					<div className="col-xs-12">
						<div className="row">
							<div className={styles.mediumSpacing}></div>
							<div
								className="col-xs-4 col-xs-offset-4 col-sm-2 col-sm-offset-1 col-md-1 col-md-offset-3 text-right">
			...
			<div className="container">
				...
				<div className="col-xs-8 col-xs-offset-2 col-sm-3 col-sm-offset-4 col-md-2 col-md-offset-2">
					...
					<div className={styles.smallSpacing}></div>
					<h5 className="text-center"><strong>BỐC THĂM HỖ TRỢ<br className="visible-lg"/> LỆ PHÍ THI
						IELTS</strong></h5>
				</div>
			</div>
			{/*sharing*/}
			...
			<div className={styles.schoolsContainer}>
				<div className="container">
					...
					<div className="col-xs-12 text-center">
						<a className={`${styles.btnBlock}`} id={`${styles.btnToForm}`} href="#registerForm"
						        type="button"><h4>ĐĂNG KÝ</h4></a>
						<div className={styles.mediumSpacing}></div>
					</div>
				</div>
			</div>
				...
				<div className="container-fluid">
					...
					<div className={`collapse navbar-collapse text-center ${styles.centerMenu}`} id="top-menu">
						<ul className="nav navbar-nav">
							...
							<li><a href="#schools" className={styles.customA}>CÁC TRƯỜNG TỔ CHỨC THAM GIA TRIỂN LÃM</a>
							</li>
						</ul>
						<ul className="nav navbar-nav navbar-right">
							<li><a href="#schools"><img className="visible-lg visible-md" height="70"
							                            src={require('../../photos/201609/logo.png')}/></a></li>
						</ul>
					</div>
				</div>
			</div>
